...
inline std::vector<std::string_view> normal_str_split(std::string_view s,
...
std::string generate_test_string(size_t length, char delimiter,
                                 size_t avg_segment_len) {
  std::string s;
...
void BM_Split(benchmark::State& state, Func split_func,
              bool return_string_view) {
