...
struct PB_equal<struct_pb_sample::rect32s, mygame::rect32s>
    : public std::binary_function<struct_pb_sample::rect32s, mygame::rect32s, bool> {
  constexpr bool operator()(const struct_pb_sample::rect32s& t,
...
struct PB_equal<struct_pb_sample::rect32, mygame::rect32>
    : public std::binary_function<struct_pb_sample::rect32, mygame::rect32, bool> {
  constexpr bool operator()(const struct_pb_sample::rect32& lhs,
...
struct PB_equal<struct_pb_sample::Vec3, mygame::Vec3>
    : public std::binary_function<struct_pb_sample::Vec3, mygame::Vec3, bool> {
  constexpr bool operator()(const struct_pb_sample::Vec3& lhs,
...
struct PB_equal<struct_pb_sample::person, mygame::person>
    : public std::binary_function<struct_pb_sample::person, mygame::person, bool> {
  constexpr bool operator()(const struct_pb_sample::person& lhs,
...
struct PB_equal<struct_pb_sample::persons, mygame::persons>
    : public std::binary_function<struct_pb_sample::persons, mygame::persons, bool> {
  constexpr bool operator()(const struct_pb_sample::persons& lhs,
...
struct PB_equal<struct_pb_sample::Weapon, mygame::Weapon>
    : public std::binary_function<struct_pb_sample::Weapon, mygame::Weapon, bool> {
  constexpr bool operator()(const struct_pb_sample::Weapon& lhs,
...
struct PB_equal<struct_pb_sample::Monster, mygame::Monster>
    : public std::binary_function<struct_pb_sample::Monster, mygame::Monster, bool> {
  constexpr bool operator()(const struct_pb_sample::Monster& lhs,
    ...
    if (lhs.pos && rhs.has_pos()) {
      ok = PB_equal<struct_pb_sample::Vec3, mygame::Vec3>()(*lhs.pos, rhs.pos());
      if (!ok) {
        return false;
      }
    }
    ...
    if (lhs.equipped && rhs.has_equipped()) {
      ok = PB_equal<struct_pb_sample::Weapon, mygame::Weapon>()(*lhs.equipped, rhs.equipped());
      if (!ok) {
        return false;
      }
    }
...
struct PB_equal<struct_pb_sample::Monsters, mygame::Monsters>
    : public std::binary_function<struct_pb_sample::Monsters, mygame::Monsters, bool> {
  constexpr bool operator()(const struct_pb_sample::Monsters& lhs,
