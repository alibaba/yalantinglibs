...
struct PB_equal<test_struct_pb::Test1, Test1>
    : public std::binary_function<test_struct_pb::Test1, Test1, bool> {
  constexpr bool operator()(const test_struct_pb::Test1& t,
                            const Test1& pb_t) const {
    return t.a == pb_t.a();
  }
};
#endif
...
struct PB_equal<test_struct_pb::Test2, Test2>
    : public std::binary_function<test_struct_pb::Test2, Test2, bool> {
  constexpr bool operator()(const test_struct_pb::Test2& t,
                            const Test2& pb_t) const {
    return t.b == pb_t.b();
  }
};
#endif
...
struct equal_to<test_struct_pb::Test3>
    : public binary_function<test_struct_pb::Test3, test_struct_pb::Test3,
                             bool> {
...
struct PB_equal<test_struct_pb::Test3, Test3>
    : public std::binary_function<test_struct_pb::Test3, Test3, bool> {
  constexpr bool operator()(const test_struct_pb::Test3& t,
                            const Test3& pb_t) const {
    if (t.c && pb_t.has_c()) {
...
struct PB_equal<test_struct_pb::Test4, Test4>
    : public std::binary_function<test_struct_pb::Test4, Test4, bool> {
  constexpr bool operator()(const test_struct_pb::Test4& t,
                            const Test4& pb_t) const {
    return t.e == pb_t.e();
  }
};
#endif
...
struct PB_equal<test_struct_pb::MyTestDouble, MyTestDouble>
    : public std::binary_function<test_struct_pb::MyTestDouble, MyTestDouble,
                                  bool> {
...
struct PB_equal<test_struct_pb::MyTestFloat, MyTestFloat>
    : public std::binary_function<test_struct_pb::MyTestFloat, MyTestFloat,
                                  bool> {
...
struct PB_equal<test_struct_pb::MyTestInt32, MyTestInt32>
    : public std::binary_function<test_struct_pb::MyTestInt32, MyTestInt32,
                                  bool> {
  constexpr bool operator()(const test_struct_pb::MyTestInt32& t,
...
struct PB_equal<test_struct_pb::MyTestInt64, MyTestInt64>
    : public std::binary_function<test_struct_pb::MyTestInt64, MyTestInt64,
                                  bool> {
  constexpr bool operator()(const test_struct_pb::MyTestInt64& t,
...
struct PB_equal<test_struct_pb::MyTestUint32, MyTestUint32>
    : public std::binary_function<test_struct_pb::MyTestUint32, MyTestUint32,
                                  bool> {
  constexpr bool operator()(const test_struct_pb::MyTestUint32& t,
...
struct PB_equal<test_struct_pb::MyTestUint64, MyTestUint64>
    : public std::binary_function<test_struct_pb::MyTestUint64, MyTestUint64,
                                  bool> {
  constexpr bool operator()(const test_struct_pb::MyTestUint64& t,
...
struct PB_equal<test_struct_pb::MyTestEnum, MyTestEnum>
    : public std::binary_function<test_struct_pb::MyTestEnum, MyTestEnum,
                                  bool> {
  constexpr bool operator()(const test_struct_pb::MyTestEnum& t,
...
struct PB_equal<test_struct_pb::MyTestRepeatedMessage, MyTestRepeatedMessage>
    : public std::binary_function<test_struct_pb::MyTestRepeatedMessage,
                                  MyTestRepeatedMessage, bool> {
  constexpr bool operator()(const test_struct_pb::MyTestRepeatedMessage& t,
...
struct PB_equal<test_struct_pb::MyTestSint32, MyTestSint32>
    : public std::binary_function<test_struct_pb::MyTestSint32, MyTestSint32,
                                  bool> {
  constexpr bool operator()(const test_struct_pb::MyTestSint32& t,
...
struct PB_equal<test_struct_pb::MyTestSint64, MyTestSint64>
    : public std::binary_function<test_struct_pb::MyTestSint64, MyTestSint64,
                                  bool> {
  constexpr bool operator()(const test_struct_pb::MyTestSint64& t,
...
struct PB_equal<test_struct_pb::MyTestMap, MyTestMap>
    : public std::binary_function<test_struct_pb::MyTestMap, MyTestMap, bool> {
...
struct PB_equal<test_struct_pb::MyTestFixed32, MyTestFixed32>
    : public std::binary_function<test_struct_pb::MyTestFixed32, MyTestFixed32,
                                  bool> {
  constexpr bool operator()(const test_struct_pb::MyTestFixed32& t,
...
struct PB_equal<test_struct_pb::MyTestFixed64, MyTestFixed64>
    : public std::binary_function<test_struct_pb::MyTestFixed64, MyTestFixed64,
                                  bool> {
  constexpr bool operator()(const test_struct_pb::MyTestFixed64& t,
...
struct PB_equal<test_struct_pb::MyTestSfixed32, MyTestSfixed32>
    : public std::binary_function<test_struct_pb::MyTestSfixed32,
                                  MyTestSfixed32, bool> {
  constexpr bool operator()(const test_struct_pb::MyTestSfixed32& t,
...
struct PB_equal<test_struct_pb::MyTestSfixed64, MyTestSfixed64>
    : public std::binary_function<test_struct_pb::MyTestSfixed64,
                                  MyTestSfixed64, bool> {
  constexpr bool operator()(const test_struct_pb::MyTestSfixed64& t,
...
struct PB_equal<test_struct_pb::MyTestFieldNumberRandom,
    ...
    : public std::binary_function<test_struct_pb::MyTestFieldNumberRandom,
                                  MyTestFieldNumberRandom, bool> {
  constexpr bool operator()(const test_struct_pb::MyTestFieldNumberRandom& t,
...
struct PB_equal<test_struct_pb::MyTestAll, MyTestAll>
    : public std::binary_function<test_struct_pb::MyTestAll, MyTestAll, bool> {
  constexpr bool operator()(const test_struct_pb::MyTestAll& t,
