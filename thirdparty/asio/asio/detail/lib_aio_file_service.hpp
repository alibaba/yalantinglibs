//
// detail/lib_aio_file_service.hpp
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
...
#ifndef ASIO_DETAIL_LIB_AIO_FILE_SERVICE_HPP
#define ASIO_DETAIL_LIB_AIO_FILE_SERVICE_HPP
...
// Extend the lib_aio_descriptor_service to provide file support.
class lib_aio_file_service : 
  public execution_context_service_base<lib_aio_file_service>
{
public:
  typedef lib_aio_descriptor_service descriptor_service;
  ...
  private:
    ...
    friend class lib_aio_file_service;

    bool is_stream_;
  };

  ASIO_DECL lib_aio_file_service(execution_context& context);
  ...
  void move_assign(implementation_type& impl,
      lib_aio_file_service& other_service,
      implementation_type& other_impl)
  {
  ...
  {
    return descriptor_service_.size(impl, ec);
  }
  ...
  {
    return descriptor_service_.seek(impl, offset, whence, ec);
  }
  ...
  // Start an asynchronous read. The buffer for the data being read muste be
  ...
  // Read some data. Return the number of bytes read.
  template<typename MutableBufferSequence>
...
# include "asio/detail/impl/lib_aio_file_service.ipp"
#endif // defined(ASIO_HEADER_ONLY)

#endif // defined(ASIO_HAS_FILE)
       //   && defined(ASIO_HAS_LIB_AIO)

#endif // ASIO_DETAIL_LIB_AIO_FILE_SERVICE_HPP
