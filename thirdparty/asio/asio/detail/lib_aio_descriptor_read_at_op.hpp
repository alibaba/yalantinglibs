//
// detail/lib_aio_descriptor_read_at_op.hpp
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
...
#ifndef ASIO_DETAIL_LIB_AIO_DESCRIPTOR_READ_AT_OP_HPP
#define ASIO_DETAIL_LIB_AIO_DESCRIPTOR_READ_AT_OP_HPP
...
class lib_aio_descriptor_read_at_op_base : public reactor_op
{
public:
  lib_aio_descriptor_read_at_op_base(
      const asio::error_code& success_ec, int descriptor,
      descriptor_ops::state_type state, int event_fd, io_context_t* aio_ctx, 
      func_type complete_func)
    : reactor_op(success_ec,
        &lib_aio_descriptor_read_at_op_base::do_perform, complete_func),
      event_fd_(event_fd),
      aio_ctx_(aio_ctx),
  ...
  {
    lib_aio_descriptor_read_at_op_base* o(
        static_cast<lib_aio_descriptor_read_at_op_base*>(base));
...
class lib_aio_descriptor_read_at_op
  : public lib_aio_descriptor_read_at_op_base<MutableBufferSequence>
{
public:
  typedef Handler handler_type;
  typedef IoExecutor io_executor_type;

  ASIO_DEFINE_HANDLER_PTR(lib_aio_descriptor_read_at_op);

  lib_aio_descriptor_read_at_op(const asio::error_code& success_ec,
      int descriptor, descriptor_ops::state_type state, int event_fd, io_context_t* aio_ctx,
      Handler& handler, const IoExecutor& io_ex)
    : lib_aio_descriptor_read_at_op_base<MutableBufferSequence>(
        success_ec, descriptor, state, event_fd, aio_ctx,
        &lib_aio_descriptor_read_at_op::do_complete),
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    lib_aio_descriptor_read_at_op* o
      (static_cast<lib_aio_descriptor_read_at_op*>(base));
  ...
  {
    // Take ownership of the handler object.
    lib_aio_descriptor_read_at_op* o(static_cast<lib_aio_descriptor_read_at_op*>(base));
    ptr p = { asio::detail::addressof(o->handler_), o, o };
