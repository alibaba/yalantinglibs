...
namespace ylt {
    ...
    static inline std::vector<std::string> split_str(std::string_view string, const char delim) {
        return simd_str_split<std::string>(string, delim);
    }

    static inline std::vector<std::string_view> split_sv(std::string_view string, const char delim) {
