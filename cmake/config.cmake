...
option(YLT_ENABLE_BAREX "Enable accl barex support" OFF)
if (YLT_ENABLE_BAREX)
    message(STATUS "Enable barex support")
    if(CMAKE_PROJECT_NAME STREQUAL "yaLanTingLibs")
        add_compile_definitions("YLT_ENABLE_BAREX")
        link_libraries(/usr/lib64/libaccl_barex_static.a -lrt)
    else ()
        target_compile_definitions(${ylt_target_name} INTERFACE "YLT_ENABLE_BAREX")
        target_link_libraries(${ylt_target_name} INTERFACE /usr/lib64/libaccl_barex_static.a -lrt)
    endif ()
endif ()
