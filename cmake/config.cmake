...
if(NOT CMAKE_PROJECT_NAME STREQUAL "yaLanTingLibs")
    target_link_libraries(yalantinglibs::yalantinglibs INTERFACE Threads::Threads)
    if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
        target_link_libraries(yalantinglibs::yalantinglibs INTERFACE dl)
    endif()
endif()
option(YLT_ENABLE_LD "Enable ld support" ON)
if (YLT_ENABLE_LD)
    if(CMAKE_PROJECT_NAME STREQUAL "yaLanTingLibs")
        add_compile_definitions("YLT_ENABLE_LD")
    else ()
        target_compile_definitions(yalantinglibs INTERFACE "YLT_ENABLE_LD")
    endif ()
endif()
...
if (YLT_ENABLE_SSL)
    ...
    if(CMAKE_PROJECT_NAME STREQUAL "yaLanTingLibs")
        ...
        target_compile_definitions(yalantinglibs::yalantinglibs INTERFACE "YLT_ENABLE_SSL")
        target_link_libraries(yalantinglibs::yalantinglibs INTERFACE OpenSSL::SSL OpenSSL::Crypto)
    endif ()
endif ()
...
if (YLT_ENABLE_IBV)
    ...
    if(CMAKE_PROJECT_NAME STREQUAL "yaLanTingLibs")
        ...
        target_compile_definitions(yalantinglibs::yalantinglibs INTERFACE "YLT_ENABLE_IBV")
        target_link_libraries(yalantinglibs::yalantinglibs -libverbs)
    endif ()
endif ()
...
if (YLT_ENABLE_PMR)
    if(CMAKE_PROJECT_NAME STREQUAL "yaLanTingLibs")
        ...
        target_compile_definitions(yalantinglibs::yalantinglibs INTERFACE "YLT_ENABLE_PMR" IGUANA_ENABLE_PMR)
    endif ()
endif ()
...
if (YLT_ENABLE_IO_URING)
  ...
  if(CMAKE_PROJECT_NAME STREQUAL "yaLanTingLibs")
      ...
      target_compile_definitions(yalantinglibs::yalantinglibs INTERFACE ASIO_HAS_IO_URING ASIO_DISABLE_EPOLL ASIO_HAS_FILE YLT_ENABLE_FILE_IO_URING)
      target_link_libraries(yalantinglibs::yalantinglibs INTERFACE uring)
  endif ()
endif()
...
if (NOT YLT_ENABLE_IO_URING)
  if(YLT_ENABLE_FILE_IO_URING)
    ...
    if(CMAKE_PROJECT_NAME STREQUAL "yaLanTingLibs")
        ...
        target_compile_definitions(yalantinglibs::yalantinglibs INTERFACE ASIO_HAS_IO_URING ASIO_HAS_FILE "YLT_ENABLE_FILE_IO_URING")
        target_link_libraries(yalantinglibs::yalantinglibs INTERFACE uring)
    endif ()
  endif()
endif()
...
if(YLT_ENABLE_STRUCT_PACK_OPTIMIZE)
    if(CMAKE_PROJECT_NAME STREQUAL "yaLanTingLibs")
        ...
        target_compile_definitions(yalantinglibs::yalantinglibs INTERFACE YLT_ENABLE_STRUCT_PACK_OPTIMIZE)
    endif ()
endif()
message(STATUS "--------------------------------------------")
